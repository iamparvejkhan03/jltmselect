...
import { BrokerContainer, BrokerHeader, BrokerSidebar } from "../../components";
...
// Mock notifications data for brokers
const notificationsData = [
    ...
    },
    {
        ...
        message: "Robert Kim left a 5-star review: 'Excellent broker! Fast shipping and item as described.'",
        rating: 5,
        reviewer: "Robert Kim",
                ...
                <BrokerContainer>
                    ...
                    <div className="max-w-full pt-16 pb-7 md:pt-0">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h2 className="text-3xl md:text-4xl font-bold my-5">Broker Notifications</h2>
                    ...
                    {showSettings && (
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                            <h3 className="text-lg font-semibold mb-4">Broker Notification Preferences</h3>
                        ...
                        {filteredNotifications.length > 0 ? (
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                                ...
                                <p className="text-gray-500 mb-6">
                                    {filter === "all"
                                        ? "You're all caught up! No new broker notifications."
                    ...
                    {filteredNotifications.length > 0 && (
                        <div className="mt-8 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 border border-blue-200">
                            <h4 className="font-semibold text-gray-900 mb-4">Broker Activity Summary</h4>
