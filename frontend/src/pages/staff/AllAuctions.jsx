...
import { StaffContainer, StaffHeader, StaffSidebar, LoadingSpinner, PaymentStatusDropdown } from "../../components";
                    ...
                    <div className="max-w-full pt-16 pb-7 md:pt-0">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                            ...
                            <div className="mt-4 md:mt-0 flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
                                ...
                                <Link
                                    to="/staff/auctions/create"
                                    className="bg-primary text-white hover:bg-primary/90 px-4 py-2 rounded-lg font-medium flex items-center gap-2 transition-colors"
                                >
                                    <Plus size={18} />
                                    Create Auction
                                </Link>
