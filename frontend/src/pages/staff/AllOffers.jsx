...
function AllOffers() {
    ...
    const handleRespondToOffer = async () => {
        ...
        try {
            ...
            if (res.data.success) {
                toast.success(`Offer ${responseData.action}ed by staff`);
    ...
    const handleCancelOffer = async () => {
        ...
        try {
            ...
            if (res.data.success) {
                toast.success('Offer cancelled by staff');
    ...
    const handleReactivateOffer = async () => {
        ...
        try {
            ...
            const res = await axiosInstance.post(`/api/v1/offers/${selectedOffer._id}/reactivate`, {
                auctionId: selectedOffer.auction._id,
                reason: "Offer reactivated by staff"
            });
                                ...
                                <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="mt-6 pt-6 border-t border-gray-200">
                                            <h4 className="font-medium text-gray-700 mb-4">Staff Actions</h4>
                                            <div className="flex flex-wrap gap-3">
                                                {selectedOffer.status === 'pending' && (
                                                    <>
                                                        <button
                                                            onClick={() => {
                                                                setResponseData({ action: 'accept', message: 'Offer accepted by staff' });
                                                        ...
                                                        <button
                                                            onClick={() => {
                                                                setResponseData({ action: 'reject', message: 'Offer rejected by staff' });
                                                                setShowRespondModal(true);
                                                            }}
