...
import {
    ...
    Clock, Banknote, Hand, FileText, CheckCircle, AlertCircle,
        ...
        <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                    type="submit"
                    disabled={saving}
                    className="bg-gradient-to-r from-primary via-primary/90 to-primary/80 text-white hover:from-primary/90 hover:via-primary/80 hover:to-primary/70 px-6 py-3 rounded-lg transition-colors disabled:opacity-50"
                >
