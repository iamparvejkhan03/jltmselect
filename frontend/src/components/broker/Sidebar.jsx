...
const navigation = [
    ...
    { name: 'All Auctions', path: '/broker/auctions/all', icon: <Gavel size={20} /> },
    { name: 'Create Auction', path: '/broker/auctions/create', icon: <Plus size={20} /> },
    { name: 'Sold Auctions', path: '/broker/auctions/sold', icon: <Award size={20} /> },
