            ...
            <div className="flex items-center space-x-4 md:space-x-5">
                ...
                <div className="flex items-center space-x-3 pl-3 border-l border-gray-200">
                    ...
                    </div>
                    {
                        user?.image
                            ?
                            <Link to={`/bidder/profile`}><img src={user?.image} alt="userImage" className="h-10 w-10 rounded-full object-cover" /></Link>
                            :
                            <Link to={`/bidder/profile`} className = "h-10 w-10 rounded-full bg-gradient-to-r from-bg-primary to-bg-primary/80 flex items-center justify-center text-white font-semibold">
